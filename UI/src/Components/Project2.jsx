  ...
  const projects = [
    {
      ...
      description: 'Streamlining leave re-quests for employees and managers.',
      tags: ['React', 'TailwindCSS', 'MongoDB', 'Express', 'Javascript','Docker'],
    },
      ...
      <div className="flex flex-wrap justify-center">
        {projects.map((project, index) => (
          <div key={index} className="max-w-sm rounded overflow-hidden shadow-lg bg-amber-200 dark:bg-gray-800 text-black dark:text-white m-4 shadow-lg transform transition duration-300 hover:scale-105">
            <img className="w-full h-54" src="/src/assets/Leaveletter.png" alt={project.title} />
